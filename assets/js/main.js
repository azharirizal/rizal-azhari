...
(function() {
  ...
  function mobileNavToogle() {
    ...
    // Toggle inner icon classes (we use a button with an <i> inside)
    const icon = mobileNavToggleBtn.querySelector('.toggle-icon');
    if (icon) {
      icon.classList.toggle('bi-list');
      icon.classList.toggle('bi-x');
    }

    // Toggle aria-expanded for accessibility and swap label text
    const label = mobileNavToggleBtn.querySelector('.toggle-label');
